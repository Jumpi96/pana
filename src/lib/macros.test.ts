...
describe('calculateMealMacros', () => {
  it('should calculate macros for a meal with ok portion', () => {
    const meal: MealEntry = {
      ...
      alcohol_g: 0,
      alcohol_calories: 0,
      base_calories_min: null,
      base_calories_max: null,
      base_protein_g_min: null,
      base_protein_g_max: null,
      base_carbs_g_min: null,
      base_carbs_g_max: null,
      base_fat_g_min: null,
      base_fat_g_max: null,
      base_alcohol_g: null,
      base_alcohol_calories: null,
      uncertainty: false,
      portion_level: 'ok',
      created_at: '2024-01-01',
      updated_at: '2024-01-01',
